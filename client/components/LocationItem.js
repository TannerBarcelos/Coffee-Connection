...
async function onClick(e, shopName, image_url, url, phone, address, rating, id, userInformation) {
  /**
...
function LocationItem({
  ...
  return (
    <div className="ui card" style={{width: "400px", height: "470px", marginTop: "none"}}>
      <div style={{width: "100%", height: "280px", textAlign: "center", marginBottom: "1rem"}}>
        <img src={image_url} style={{width: "100%", height: "100%", objectFit: "cover", marginTop: "1rem"}}/>
      </div>
      <div className="content" style={{marginTop: "1rem"}}>
          {isAuthenticated ? (
            ...
            style={{width: '30px', height: '30px', position: 'absolute', top: '.8rem', right: '0'}}
          >
            <i
              data-shop__id={id}
              onClick={e => onClick(e, shopName, image_url, url, phone, address, rating, id, userInformation)}
    ...
    <div className="extra content">
      ...
      <a href={url} target="_blank" className="ui google plus button">See on Yelp! <i className="fab fa-yelp" style={{fontSize:"1.3rem", color:"#fff"}}></i></a>
    </div>
  </div>
  )
}
